...
import { ScientificChart, ChartType as SCChartType } from "./ScientificChart";
import { CanvasScatterGraph } from "./charts/CanvasScatterGraph";
import { CorrelationMatrix } from "./charts/CorrelationMatrix";
import { SimilarityGraph } from "./charts/SimilarityGraph";
import { RheologyGraph } from "./charts/RheologyGraph";
import { useSimilarityWorker } from "../hooks/useSimilarity";
import { useRsmWorker } from "../hooks/useRsmWorker";
import { useParetoWorker } from "../hooks/useParetoWorker";
import { useTheme } from "../contexts/ThemeContext";
import { useFeatureImportanceWorker } from "../hooks/useFeatureImportanceWorker";
import { useKdeWorker } from "../hooks/useKdeWorker";
import { useWeibullWorker } from "../hooks/useWeibullWorker";
import { useWlfWorker } from "../hooks/useWlfWorker";
import { useCopulaWorker } from "../hooks/useCopulaWorker";
import { useArrheniusWorker } from "../hooks/useArrheniusWorker";
import { ArrheniusChart } from "./charts/ArrheniusChart";
import { useSobolWorker } from "../hooks/useSobolWorker";
import { SobolChart } from "./charts/SobolChart";
import { useSpcWorker } from "../hooks/useSpcWorker";
import { SpcChart } from "./charts/SpcChart";
import { RADAR_KEYS, getPerformanceFingerprint } from "../productUtils";
...
import { useKMeansWorker } from "../hooks/useKMeansWorker";
import { materialEngine } from "../lib/materialScience";
import { useBayesWorker } from "../hooks/useBayesWorker";
import { BayesChart } from "./charts/BayesChart";
import { useMooWorker } from "../hooks/useMooWorker";
import { MooChart } from "./charts/MooChart";
import { useMahalanobisWorker } from "../hooks/useMahalanobisWorker";

import { MahalanobisChart } from "./charts/MahalanobisChart";
import { useKineticsWorker } from "../hooks/useKineticsWorker";
import { KineticsChart } from "./charts/KineticsChart";
import { usePronyWorker } from "../hooks/usePronyWorker";
import { PronyChart } from "./charts/PronyChart";
import { formulaEngine } from "../lib/formulaParser";
import { useFormulas } from "../hooks/useFormulas";
import { RsmHeatmapChart } from "./charts/RsmHeatmapChart";
import { FeatureImportanceChart } from "./charts/FeatureImportanceChart";
import { KdeTopologyChart } from "./charts/KdeTopologyChart";
import { WeibullChart } from "./charts/WeibullChart";
import { WlfTtsChart } from "./charts/WlfTtsChart";
import { CopulaChart } from "./charts/CopulaChart";
...
export const DataVisualizer: React.FC<DataVisualizerProps> = React.memo(
  ({ data, selectedProducts, initialChartType, formulas: propFormulas }) => {
    ...
    const updateFilter = (key: string, field: "min" | "max", val: string) => {
