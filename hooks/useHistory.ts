...
import type { HistoryWorkerMessage, HistoryWorkerResponse } from '../lib/historyWorker';
...
export function useHistory(
  ...
  useEffect(() => {
    const worker = new Worker(new URL('../lib/historyWorker.ts', import.meta.url), { type: 'module' });
