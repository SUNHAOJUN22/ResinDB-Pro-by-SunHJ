...
import { Product, User, Toast, ProductUpdates } from '../types';
import { api } from '../api';
...
export function useAppActions({
    ...
    }, [allProducts, setAllProducts, setSelectedIds, addToast, t, setShowSidebar]);
    ...
    }, [allProducts, setAllProducts, addToast, t, setShowSidebar]);
