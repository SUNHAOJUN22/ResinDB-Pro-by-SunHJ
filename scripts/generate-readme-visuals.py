...
VISUALS = (
    ...
    Visual(
        ...
        "Permanent quality gates for documentation, static analysis, regression tests, build, browser smoke and dependency audit.",
        "grid",
        (
